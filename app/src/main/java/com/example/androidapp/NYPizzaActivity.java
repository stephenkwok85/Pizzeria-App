...
public class NYPizzaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ny_pizza); // NYPizza layout
        ...
        pizzaFactory = new NYPizza(); // Using NYPizza factory
    ...
    private void updateToppingCount(boolean isChecked) {
        if (isChecked) {
            if (selectedToppingsCount < MAX_TOPPINGS) {
                ...
                Toast.makeText(NYPizzaActivity.this, "You can only select up to " + MAX_TOPPINGS + " toppings.", Toast.LENGTH_SHORT).show();
            }
        } else {
            selectedToppingsCount--;
            if (selectedToppingsCount < MAX_TOPPINGS) {
    ...
    private void addOrder() {
        ...
        try {
            ...
            Toast.makeText(NYPizzaActivity.this, "Order #" + orderNumber + " added to your cart", Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            Toast.makeText(this, "Failed to add pizza to order: " + e.getMessage(), Toast.LENGTH_SHORT).show();
            Log.e("NYPizzaActivity", "Error adding order", e);
        }
    }
